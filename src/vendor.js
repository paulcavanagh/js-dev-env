/* This file contains reference to the vendor libraries
   ...
   the application's code. So all the libnraries we reference
   here will be written to vendor.js so they will be cached
   ...
   which should be less frequent. Any files that aren't reference here
